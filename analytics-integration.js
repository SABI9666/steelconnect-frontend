...
.ad-portal { background:linear-gradient(165deg,#f0f2ff 0%,#f8fafc 30%,#faf5ff 60%,#f0fdfa 100%); min-height:100vh; font-family:'Inter','Segoe UI',system-ui,sans-serif; }

/* Loading */
.ad-loading-screen { display:flex; flex-direction:column; align-items:center; justify-content:center; height:70vh; gap:24px; text-align:center; }
.ad-loading-orb { position:relative; width:100px; height:100px; display:flex; align-items:center; justify-content:center; }
...
.ad-loading-fill { width:40%; height:100%; background:linear-gradient(90deg,#6366f1,#8b5cf6,#6366f1); background-size:200% 100%; border-radius:4px; animation:adSlide 1.5s ease infinite; }
@keyframes adSlide { 0%{transform:translateX(-100%)} 100%{transform:translateX(350%)} }

/* Hero Header */
.ad-hero-header { position:relative; padding:48px 40px 44px; overflow:hidden; border-radius:0 0 32px 32px; }
.ad-hero-bg { position:absolute; inset:0; }
.ad-hero-gradient { position:absolute; inset:0; background:linear-gradient(135deg,#0f0a2e 0%,#1e1b4b 20%,#312e81 45%,#4338ca 70%,#6366f1 100%); }
.ad-hero-pattern { position:absolute; inset:0; opacity:.06; background-image:radial-gradient(circle at 1px 1px,rgba(255,255,255,.8) 1px,transparent 0); background-size:24px 24px; }
.ad-hero-orb { position:absolute; border-radius:50%; filter:blur(60px); }
.ad-hero-orb-1 { width:300px; height:300px; background:rgba(139,92,246,.35); top:-80px; right:-40px; animation:adFloat 8s ease-in-out infinite; }
.ad-hero-orb-2 { width:200px; height:200px; background:rgba(99,102,241,.25); bottom:-60px; left:10%; animation:adFloat 10s ease-in-out infinite reverse; }
.ad-hero-orb-3 { width:150px; height:150px; background:rgba(6,182,212,.2); top:20%; right:30%; animation:adFloat 12s ease-in-out infinite; }
@keyframes adFloat { 0%,100%{transform:translate(0,0) scale(1)} 50%{transform:translate(20px,-20px) scale(1.1)} }
...
.ad-hero-icon-box { width:60px; height:60px; background:rgba(255,255,255,.12); backdrop-filter:blur(16px); border-radius:18px; display:flex; align-items:center; justify-content:center; color:#fff; font-size:1.6rem; border:1px solid rgba(255,255,255,.18); }
.ad-hero-text h1 { color:#fff; font-size:2rem; font-weight:900; margin:0; letter-spacing:-.03em; }
...
.ad-hero-btn { background:rgba(255,255,255,.12); backdrop-filter:blur(12px); border:1px solid rgba(255,255,255,.2); color:#fff; padding:12px 24px; border-radius:14px; font-weight:600; cursor:pointer; transition:all .3s; display:flex; align-items:center; gap:8px; font-size:.9rem; }
.ad-hero-btn:hover { background:rgba(255,255,255,.22); transform:translateY(-2px); }

/* Content */
.ad-content { padding:32px 40px 60px; max-width:1400px; margin:0 auto; }

/* Upload Section */
.ad-upload-section { margin-bottom:28px; }
.ad-upload-card { display:flex; justify-content:space-between; align-items:center; background:#fff; padding:28px 32px; border-radius:20px; border:1px solid rgba(0,0,0,.04); box-shadow:0 1px 3px rgba(0,0,0,.03),0 4px 20px rgba(0,0,0,.04); gap:20px; flex-wrap:wrap; }
.ad-upload-left { display:flex; align-items:center; gap:18px; flex:1; }
.ad-upload-icon-box { width:56px; height:56px; background:linear-gradient(135deg,rgba(16,185,129,.1),rgba(6,182,212,.1)); border-radius:16px; display:flex; align-items:center; justify-content:center; color:#10b981; font-size:1.4rem; flex-shrink:0; }
.ad-upload-left h3 { margin:0; font-size:1.15rem; font-weight:800; color:#0f172a; }
.ad-upload-left p { margin:4px 0 0; font-size:.85rem; color:#64748b; line-height:1.5; }
.ad-upload-btn { background:linear-gradient(135deg,#10b981,#059669); color:#fff; border:none; padding:14px 28px; border-radius:14px; font-weight:700; cursor:pointer; font-size:.95rem; display:flex; align-items:center; gap:10px; transition:all .3s; box-shadow:0 4px 16px rgba(16,185,129,.3); white-space:nowrap; }
.ad-upload-btn:hover { transform:translateY(-3px); box-shadow:0 8px 28px rgba(16,185,129,.4); }

/* Portal Stats */
.ad-portal-stats { display:grid; grid-template-columns:repeat(4,1fr); gap:14px; margin-bottom:32px; }
.ad-portal-stat { background:#fff; border-radius:16px; padding:20px; text-align:center; border:1px solid rgba(0,0,0,.04); box-shadow:0 1px 3px rgba(0,0,0,.03); transition:all .3s; }
.ad-portal-stat:hover { transform:translateY(-3px); box-shadow:0 8px 24px rgba(0,0,0,.08); }
.ad-ps-icon { width:44px; height:44px; border-radius:12px; display:flex; align-items:center; justify-content:center; font-size:1.1rem; margin:0 auto 12px; }
.ad-ps-num { font-size:1.8rem; font-weight:900; color:#0f172a; }
.ad-ps-label { font-size:.78rem; color:#64748b; font-weight:600; margin-top:4px; }

/* Section Header */
.ad-section-header { display:flex; justify-content:space-between; align-items:center; margin-bottom:18px; }
.ad-section-header h3 { font-size:1.1rem; font-weight:700; color:#1e293b; margin:0; display:flex; align-items:center; gap:10px; }
.ad-section-header h3 i { font-size:.9rem; }
.ad-section-count { background:rgba(245,158,11,.1); color:#d97706; padding:4px 12px; border-radius:8px; font-size:.78rem; font-weight:700; }
.ad-section-count.success { background:rgba(16,185,129,.1); color:#059669; }

/* Pending Cards */
.ad-pending-grid { display:grid; grid-template-columns:repeat(auto-fill,minmax(400px,1fr)); gap:16px; margin-bottom:24px; }
.ad-pending-card { background:#fff; border-radius:18px; overflow:hidden; border:1px solid rgba(0,0,0,.04); box-shadow:0 1px 3px rgba(0,0,0,.03),0 4px 16px rgba(0,0,0,.04); }
.ad-pending-status-bar { height:3px; background:linear-gradient(90deg,#f59e0b,#fbbf24); }
.ad-pending-body { padding:22px; }
.ad-pending-head { display:flex; align-items:center; gap:14px; margin-bottom:14px; }
.ad-pending-icon { width:42px; height:42px; background:rgba(245,158,11,.08); border-radius:12px; display:flex; align-items:center; justify-content:center; color:#f59e0b; font-size:1.1rem; flex-shrink:0; }
.ad-pending-info { flex:1; min-width:0; }
.ad-pending-info h4 { margin:0; font-size:.95rem; font-weight:700; color:#1e293b; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
.ad-pending-file { font-size:.78rem; color:#64748b; display:flex; align-items:center; gap:4px; }
.ad-status-pill { display:inline-flex; align-items:center; gap:5px; padding:5px 12px; border-radius:20px; font-size:.75rem; font-weight:700; white-space:nowrap; }
.ad-status-pill.pending { background:rgba(245,158,11,.1); color:#d97706; }
.ad-status-pill.rejected { background:rgba(239,68,68,.1); color:#dc2626; }
.ad-pending-meta { display:flex; flex-wrap:wrap; gap:16px; font-size:.78rem; color:#94a3b8; font-weight:500; margin-bottom:14px; }
.ad-pending-meta span { display:flex; align-items:center; gap:5px; }
.ad-pending-footer { display:flex; justify-content:space-between; align-items:center; padding-top:14px; border-top:1px solid #f1f5f9; gap:12px; }
.ad-pending-note { font-size:.78rem; color:#64748b; display:flex; align-items:center; gap:6px; flex:1; }
.ad-pending-delete { width:32px; height:32px; border-radius:8px; border:1px solid #e2e8f0; background:#fff; color:#94a3b8; cursor:pointer; display:flex; align-items:center; justify-content:center; transition:all .2s; flex-shrink:0; }
.ad-pending-delete:hover { color:#dc2626; background:rgba(239,68,68,.05); border-color:#fca5a5; }

/* Rejected */
.ad-rejected-list { margin-bottom:24px; }
.ad-rejected-item { display:flex; align-items:center; gap:14px; background:#fff; padding:14px 20px; border-radius:12px; border:1px solid rgba(0,0,0,.04); margin-bottom:8px; font-size:.88rem; }
.ad-rejected-item i { color:#ef4444; }

/* Approved Cards */
.ad-approved-grid { display:grid; grid-template-columns:repeat(auto-fill,minmax(380px,1fr)); gap:18px; margin-bottom:32px; }
.ad-approved-card { background:#fff; border-radius:20px; overflow:hidden; border:1px solid rgba(0,0,0,.04); box-shadow:0 1px 3px rgba(0,0,0,.03),0 4px 20px rgba(0,0,0,.04); transition:all .4s; }
.ad-approved-card:hover { transform:translateY(-6px); box-shadow:0 12px 40px rgba(0,0,0,.1); }
.ad-approved-strip { height:3px; background:linear-gradient(90deg,#10b981,#06b6d4); }
.ad-approved-body { padding:24px; }
.ad-approved-head { display:flex; align-items:center; gap:14px; margin-bottom:14px; }
.ad-approved-icon { width:46px; height:46px; background:linear-gradient(135deg,rgba(16,185,129,.1),rgba(6,182,212,.08)); border-radius:14px; display:flex; align-items:center; justify-content:center; color:#10b981; font-size:1.2rem; flex-shrink:0; }
.ad-approved-head h4 { margin:0; font-size:1.05rem; font-weight:700; color:#1e293b; }
.ad-approved-head p { margin:2px 0 0; font-size:.82rem; color:#64748b; }
.ad-approved-meta { display:flex; flex-wrap:wrap; gap:16px; font-size:.78rem; color:#94a3b8; font-weight:500; margin-bottom:16px; }
.ad-approved-meta span { display:flex; align-items:center; gap:5px; }
.ad-approved-cta { display:flex; justify-content:space-between; align-items:center; padding-top:14px; border-top:1px solid #f1f5f9; color:#6366f1; font-weight:600; font-size:.88rem; }
.ad-approved-cta span { display:flex; align-items:center; gap:6px; }

/* No Approved State */
.ad-no-approved { text-align:center; padding:60px 20px; background:#fff; border-radius:20px; border:2px dashed #e2e8f0; }
.ad-no-approved-icon { font-size:2.5rem; color:#cbd5e1; margin-bottom:16px; }
.ad-no-approved h4 { margin:0 0 8px; font-size:1.1rem; font-weight:700; color:#475569; }
.ad-no-approved p { margin:0; color:#94a3b8; font-size:.88rem; max-width:400px; margin:0 auto; line-height:1.6; }

/* Upload Modal */
.ad-upload-modal { padding:8px; }
.ad-upload-modal-header { display:flex; align-items:center; gap:16px; margin-bottom:24px; }
.ad-upload-modal-icon { width:48px; height:48px; background:linear-gradient(135deg,rgba(16,185,129,.1),rgba(6,182,212,.08)); border-radius:14px; display:flex; align-items:center; justify-content:center; color:#10b981; font-size:1.3rem; flex-shrink:0; }
.ad-upload-modal-header h3 { margin:0; font-size:1.2rem; font-weight:800; color:#0f172a; }
...
.ad-form-group label { font-size:.82rem; font-weight:600; color:#475569; display:flex; align-items:center; gap:6px; }
.ad-form-group label i { font-size:.75rem; color:#6366f1; }
.ad-form-input, .ad-form-select { padding:10px 14px; border:1px solid #e2e8f0; border-radius:10px; font-size:.88rem; color:#1e293b; background:#fff; outline:none; transition:all .2s; }
.ad-form-input:focus, .ad-form-select:focus { border-color:#6366f1; box-shadow:0 0 0 3px rgba(99,102,241,.1); }
.ad-file-drop { border:2px dashed #e2e8f0; border-radius:14px; padding:32px 20px; text-align:center; cursor:pointer; transition:all .2s; background:#fafbff; }
.ad-file-drop:hover, .ad-file-drop.dragover { border-color:#6366f1; background:rgba(99,102,241,.03); }
.ad-file-drop.has-file { border-color:#10b981; border-style:solid; background:rgba(16,185,129,.03); }
.ad-file-drop-content { display:flex; flex-direction:column; align-items:center; gap:8px; }
...
.ad-submit-btn:disabled { opacity:.6; cursor:not-allowed; transform:none; }
.ad-cancel-btn { background:#f1f5f9; color:#475569; border:none; padding:14px 24px; border-radius:12px; font-weight:600; cursor:pointer; font-size:.9rem; transition:all .2s; }
.ad-cancel-btn:hover { background:#e2e8f0; }
.ad-btn-spinner { width:18px; height:18px; border:2px solid rgba(255,255,255,.3); border-top-color:#fff; border-radius:50%; animation:adSpin .6s linear infinite; display:inline-block; }

/* Dashboard Viewer */
.ad-db-selector { display:flex; gap:6px; padding:0 40px; margin-top:-20px; position:relative; z-index:2; flex-wrap:wrap; }
.ad-db-tab { background:rgba(255,255,255,.8); backdrop-filter:blur(12px); border:1px solid rgba(0,0,0,.06); padding:12px 22px; border-radius:14px 14px 0 0; font-weight:600; color:#64748b; cursor:pointer; transition:all .3s; display:flex; align-items:center; gap:8px; font-size:.88rem; }
.ad-db-tab.active { background:#fff; color:#6366f1; border-bottom-color:transparent; box-shadow:0 -4px 20px rgba(99,102,241,.12); }
.ad-dashboard-bar { display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:32px; flex-wrap:wrap; gap:16px; animation:adFadeUp .5s ease-out; }
.ad-dashboard-info { display:flex; align-items:center; gap:16px; }
.ad-dashboard-icon { width:52px; height:52px; background:linear-gradient(135deg,#6366f1,#8b5cf6); border-radius:16px; display:flex; align-items:center; justify-content:center; color:#fff; font-size:1.3rem; box-shadow:0 4px 16px rgba(99,102,241,.3); }
.ad-dashboard-info h2 { font-size:1.6rem; font-weight:800; color:#0f172a; margin:0; }
.ad-dashboard-desc { color:#64748b; margin:4px 0 0; font-size:.9rem; }
.ad-dashboard-meta-pills { display:flex; gap:8px; flex-wrap:wrap; }
.ad-meta-pill { display:inline-flex; align-items:center; gap:6px; padding:8px 16px; border-radius:10px; font-size:.8rem; font-weight:600; background:#fff; border:1px solid rgba(0,0,0,.06); }
...
/* KPI Grid */
.ad-kpi-grid { display:grid; grid-template-columns:repeat(auto-fill,minmax(240px,1fr)); gap:18px; margin-bottom:32px; }
.ad-kpi-card { background:#fff; border-radius:20px; padding:24px; position:relative; overflow:hidden; border:1px solid rgba(0,0,0,.04); box-shadow:0 1px 3px rgba(0,0,0,.03),0 4px 20px rgba(0,0,0,.04); transition:all .4s cubic-bezier(.4,0,.2,1); animation:adFadeUp .5s ease-out backwards; }
.ad-kpi-card:hover { transform:translateY(-6px); box-shadow:0 12px 40px rgba(0,0,0,.1); }
.ad-kpi-card::before { content:''; position:absolute; top:0; left:0; right:0; height:3px; background:var(--kpi-accent); }
.ad-kpi-glow { position:absolute; top:-40px; right:-40px; width:100px; height:100px; border-radius:50%; opacity:.06; filter:blur(20px); pointer-events:none; }
.ad-kpi-header { display:flex; justify-content:space-between; align-items:center; margin-bottom:16px; }
.ad-kpi-icon-wrap { width:48px; height:48px; border-radius:14px; display:flex; align-items:center; justify-content:center; font-size:1.15rem; }
.ad-kpi-trend-badge { display:flex; align-items:center; gap:4px; font-size:.78rem; font-weight:700; padding:5px 12px; border-radius:20px; }
...
.ad-kpi-number { font-size:2.2rem; font-weight:900; color:#0f172a; line-height:1.1; letter-spacing:-.03em; }
.ad-kpi-title { color:#64748b; font-weight:600; font-size:.85rem; margin-top:4px; text-transform:capitalize; }
.ad-kpi-footer { display:flex; align-items:center; gap:12px; padding-top:14px; border-top:1px solid #f1f5f9; }
...
/* Charts */
.ad-charts-grid { display:grid; grid-template-columns:repeat(auto-fit,minmax(500px,1fr)); gap:24px; margin-bottom:32px; }
.ad-chart-card { background:#fff; border-radius:22px; overflow:hidden; border:1px solid rgba(0,0,0,.04); box-shadow:0 1px 3px rgba(0,0,0,.03),0 4px 20px rgba(0,0,0,.04); transition:all .4s; animation:adFadeUp .5s ease-out backwards; }
.ad-chart-card:hover { box-shadow:0 12px 40px rgba(0,0,0,.1); }
.ad-chart-card.ad-fullscreen { position:fixed; inset:20px; z-index:9999; border-radius:24px; box-shadow:0 24px 80px rgba(0,0,0,.3); }
.ad-chart-header { display:flex; justify-content:space-between; align-items:center; padding:24px 28px 0; flex-wrap:wrap; gap:12px; }
...
.ad-chart-badge { display:inline-flex; align-items:center; gap:5px; font-size:.75rem; color:#94a3b8; font-weight:500; }
.ad-chart-actions { display:flex; gap:6px; align-items:center; }
.ad-chart-type-select { padding:8px 14px; border:1px solid #e2e8f0; border-radius:10px; font-size:.82rem; font-weight:600; color:#475569; background:#f8fafc; cursor:pointer; outline:none; }
.ad-chart-type-select:focus { border-color:#6366f1; box-shadow:0 0 0 3px rgba(99,102,241,.1); }
.ad-chart-action-btn { width:36px; height:36px; border-radius:10px; border:1px solid #e2e8f0; background:#f8fafc; color:#64748b; cursor:pointer; transition:all .2s; display:flex; align-items:center; justify-content:center; font-size:.85rem; }
.ad-chart-action-btn:hover { background:#6366f1; color:#fff; border-color:#6366f1; }
.ad-chart-body { padding:20px 28px 24px; height:360px; position:relative; }
.ad-chart-card.ad-fullscreen .ad-chart-body { height:calc(100% - 80px); }

/* Data Table */
.ad-data-panel { background:#fff; border-radius:22px; overflow:hidden; border:1px solid rgba(0,0,0,.04); box-shadow:0 1px 3px rgba(0,0,0,.03),0 4px 20px rgba(0,0,0,.04); margin-bottom:32px; }
.ad-data-header { display:flex; justify-content:space-between; align-items:center; padding:22px 28px; border-bottom:1px solid #f1f5f9; }
.ad-data-title { display:flex; align-items:center; gap:12px; }
.ad-data-title i { color:#6366f1; font-size:1.1rem; }
.ad-data-title h3 { font-size:1.1rem; font-weight:700; color:#1e293b; margin:0; }
.ad-data-sheet-name { background:linear-gradient(135deg,rgba(99,102,241,.08),rgba(139,92,246,.08)); color:#6366f1; padding:4px 12px; border-radius:8px; font-size:.78rem; font-weight:700; }
.ad-data-count { display:flex; align-items:center; gap:6px; color:#64748b; font-size:.85rem; font-weight:600; }
...
.ad-premium-table thead th { background:#f8fafc; padding:14px 18px; text-align:left; font-weight:700; color:#475569; font-size:.78rem; text-transform:uppercase; letter-spacing:.05em; border-bottom:2px solid #e2e8f0; }
...
/* Responsive */
@media (max-width:1024px) { .ad-charts-grid{grid-template-columns:1fr} .ad-kpi-grid{grid-template-columns:repeat(auto-fill,minmax(180px,1fr))} }
@media (max-width:768px) {
    .ad-hero-header{padding:32px 20px 36px;border-radius:0 0 24px 24px} .ad-hero-text h1{font-size:1.5rem}
    .ad-content{padding:24px 16px 48px} .ad-kpi-grid{grid-template-columns:repeat(2,1fr)}
    .ad-chart-body{height:280px} .ad-portal-stats{grid-template-columns:repeat(2,1fr)}
    .ad-pending-grid{grid-template-columns:1fr} .ad-approved-grid{grid-template-columns:1fr}
    .ad-form-row{grid-template-columns:1fr} .ad-upload-card{flex-direction:column;text-align:center}
    .ad-upload-left{flex-direction:column} .ad-dashboard-bar{flex-direction:column}
}
@media (max-width:480px) { .ad-kpi-grid{grid-template-columns:1fr 1fr} .ad-hero-left{flex-direction:column;align-items:flex-start;gap:12px} .ad-portal-stats{grid-template-columns:1fr 1fr} }
`;
